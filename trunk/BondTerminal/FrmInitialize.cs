        ...
        protected override void OnLoad(EventArgs e)
        {
            try
            {
                ...
                Task.Factory.StartNew(new Action(() =>
                {
                    ...
                    while (true)
                    {
                        if (_systemInitializeSuccess && _ConnectCameraSuccess && _ConnectLightControllerSuccess && _ConnectStageSuccess && _ConnectPowerControllerSuccess && _VisualControlInitializeSuccess && _ConnectLaserSensorSuccess && _ConnectDynamometerSuccess)
                        {
