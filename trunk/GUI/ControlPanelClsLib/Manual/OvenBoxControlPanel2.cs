...
{
    public partial class OvenBoxControlPanel2 : UserControl
    {
        /// <summary>
        /// 烘箱箱体控制
        /// </summary>
        ...
        private void Initialize()
        {
            ...
            //bool isBit0Set2 = (num & (1 << 0)) != 0;
            //bool BakeOven2AutoHeatstatus = isBit0Set;
        ...
        private void SetOvenBoxParam()
        {
            if (CurrencyOvenBox == (int)EnumOvenBoxNum.Oven1)
            {
                //烘箱加热参数
                float BakeOvenTargettemp = _systemConfig.OvenBoxConfig.HeatTargetTemperature;
                seHeatTargetTemperature.Text = BakeOvenTargettemp.ToString();
            ...
            else if (CurrencyOvenBox == (int)EnumOvenBoxNum.Oven2)
            {
                //烘箱加热参数
        ...
        private void SetOvenBoxParam(HeatRecipe heatrecip)
        {
            if(heatrecip != null)
            {
                _systemConfig.OvenBoxConfig.HeatTargetTemperature = heatrecip.TargetTemperature;
                _systemConfig.OvenBoxConfig.HeatPreservationMinute = heatrecip.HeatPreservationMinute;
                _systemConfig.OvenBoxConfig.OverTemperatureThreshold = heatrecip.OverTemperatureThreshold;
                _systemConfig.OvenBoxConfig.OvenPurgePressureUpperLimit = heatrecip.OvenPurgePressureUp;
                _systemConfig.OvenBoxConfig.OvenPurgePressureLowerLimit = heatrecip.OvenPurgePressureLower;
                _systemConfig.OvenBoxConfig.OvenPurgeTime = heatrecip.OverPurgeTime;
                _systemConfig.OvenBoxConfig.OvenPurgeInterval = heatrecip.OvenPurgeInterval;
            }
