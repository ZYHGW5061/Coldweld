...
namespace CameraControllerClsLib
{
    public class CameraManager
    {
        ...
        public CameraConfig GetCameraConfigByID(EnumCameraType cameraIndex)
        {
            CameraConfig ret = null;
            if (HardwareConfiguration.Instance.CameraConfigList.Any(i => i.CameraType == cameraIndex))
            {
                ret = HardwareConfiguration.Instance.CameraConfigList.FirstOrDefault(i => i.CameraType == cameraIndex);
            }
            return ret;
        }
