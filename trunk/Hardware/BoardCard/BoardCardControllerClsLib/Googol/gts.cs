...
namespace GTN
{
    public class mc
    {
        ...
        public const short TASK_TRIGGER_STOP = 0x1304;   				   
        public struct TTaskTriggerStop
        {
            public int axis;             //要停止的轴
            public int gpi;              //使用的捕获GPI Index
            public int auEncoder;        //捕获的AuEncoder
            public int stopOffset;       //停止偏移
            public int posErrLimit;      //捕获位置极限
            public int dump0;        //预留
            public int dump1;        //预留
            public int dump2;        //预留
            public int dump3;        //预留
...
public struct TTerminalStatus
{
    ...
    public UInt32 reserve7;
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_OpenCard(short channel, System.IntPtr pPrm, string pFileName);
        [DllImport("gts.dll")]
        public static extern short GTN_NetInit(short mode, string pFileName, short overTime, out UInt32 pStatus);
        [DllImport("gts.dll")]
        ...
        public static extern short GTN_WriteAuEncPos(short core, short encoder, ref double pPos, short count=1);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_MoveAbsoluteEx(short profile,ref TMoveAbsolutePrmEx pPrm);
        [DllImport("gts.dll")]
        public static extern short GT_GetMoveAbsoluteEx(short profile,out TMoveAbsolutePrmEx pPrm);
        [DllImport("gts.dll")]
        public static extern short GT_MoveVelocity(short profile,ref TMoveVelocityPrm pPrm);
        [DllImport("gts.dll")]
        public static extern short GT_GetMoveVelocity(short profile,out TMoveVelocityPrm pPrm);
        ...
        {
	        public Int32 lookAheadNum;             //前瞻段数
        ...
        public struct TSlaveInfo
				...
				[DllImport("gts.dll")]
        public static extern short GT_SetEcatHomingPrm(short axis,short method,double speed1,double speed2,double acc,Int32 offset,ushort probeFunction);
				[DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GetTouchProbeStatus(short axis,out ushort probeStatus,out Int32 probe1PosValue,out Int32 probe1NegValue,out Int32 probe2PosValue,out Int32 probe2NegValue);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_SetEcatAxisPV(short axis,Int32 velocity);
        [DllImport("gts.dll")]
        public static extern short GT_SetEcatAxisPT(short axis,short torque);
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatEncPos(short axis,out Int32 pEncPos);
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatAuxEncPos(short axis,out Int32 pAuxEncPos);
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatEncVel(short axis,out Int32 pVelocity);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatAxisAV(short axis,out Int32 pVel);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatAxisDI(short axis,out UInt32 pDi);
        [DllImport("gts.dll")]
        public static extern short GT_SetEcatAxisDO(short axis,UInt32 DoValue);
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatAxisDO(short axis,out UInt32 pDo);
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatSlaves(out short pSlaveMotionCnt, out short pSlaveIOCnt);
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatSlaveInfo(short slave,out TSlaveInfo pSlaveinfo);
        [DllImport("gts.dll")]
        public static extern short GT_GetEcatAxisPE(short axis,out Int32 pPosErr);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GetAuxEncoderCaptureStatus(short encoder,out ushort CapSts,out Int32 PosValue,out Int32 NegValue);
        [DllImport("gts.dll")]
        public static extern short GT_EcatSDODownload(ushort slave,ushort index,byte subindex,ref byte data,UInt32 data_size,out UInt32 abort_code);
        [DllImport("gts.dll")]
        public static extern short GT_EcatSDOUpload(ushort slave,ushort index,byte subindex,out byte target,UInt32 target_size,out UInt32 result_size,out UInt32 abort_code);
        [DllImport("gts.dll")]
        public static extern short GT_EcatIOReadInput(ushort slave,ushort offset,ushort nSize,out byte pValue);
        [DllImport("gts.dll")]
        public static extern short GT_EcatIOWriteOutput(ushort slave,ushort offset,ushort nSize,ref byte pValue);
		[DllImport("gts.dll")]
        public static extern short  GT_EcatIOBitWriteOutput(ushort slaveno,ushort offset,short Index,byte value);
		[DllImport("gts.dll")]
        public static extern short   GT_EcatIOSynch();
		[DllImport("gts.dll")]
        public static extern short   GT_GetEcatAxisPdoData(short axis,ushort objectWord,out byte pValue);
        [DllImport("gts.dll")]
        ...
        {
           public ushort skip_count;
           public ushort netOpenSts;
           public ushort slave_position;
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_InitEcatComm_MultiTask(short core,ref TEcatInitPrm ecatInit);
        ...
        public static extern short GTN_RelateEcatSlaveToMcGpiBit(short core, short gpoIndex, ushort slave, short slaveType, short bitOffset, short pdoOffset);
        [DllImport("gts.dll")]
        ...
        public struct TEcatErrInfo
       {
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_PvtTableUserData(short core, short table, short userData, double time, ref TPVTDoBit pData);
        [DllImport("gts.dll")]
    ...
    public class glink
    {
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GLinkInitEx(short cardNum, short opMode = 4);
        [DllImport("gts.dll")]
